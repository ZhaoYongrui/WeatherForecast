...
public class CityActivity extends AppCompatActivity {
    ...
    private List<Integer> idList = new ArrayList<>();//城市id
    private List<Integer> pidList = new ArrayList<>();//省份id
    private List<String> city_nameList = new ArrayList<>();//城市名
    private List<String> city_codeList = new ArrayList<>();//城市码


    private void parseJSONWithJSONObject(String jsonData) {
        //把JSON对象转化为JSONArray数组对象，解析相关信息
        try {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String responseData = getJson("city.json", this);//获取JSON
        parseJSONWithJSONObject(responseData);//转化JSON对象
